...
class Player extends Character {
    ...
    update(timePassed, totaltime) {
        /*
        WARNING! DIAGONAL FIX: The below if elseif was modified to remove diagonal mvmt. 
        If the "elses" below are removed and made into individual if statements then
        diagonal movement will be allowed again.
        */
        if (keys["ArrowRight"]) {
